...
public class AktivitaetEditGUI extends javax.swing.JFrame {
     ...
     * @param name
     */
    public AktivitaetEditGUI(String name) {
        init();
        
        // Datenbank nach dem ausgewählten Lehrer abfragen
        try {
            lehrer = verbinde.getSelectedAktivitaet(name);
